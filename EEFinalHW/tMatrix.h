...
//Hateful ass workarounds that I might not need
tMatrix_zc tMtoComplex(tMatrix);

/////////////////////////////////////////////////////////////////////////////////////////////
/*function definitions*/

tMatrix_zc tMtoComplex(tMatrix xnmod){
 int n;
 tComplex_c z;
 tMatrix_zc xnmod_c;
...
tMatrix_zc tMatCon_pc(tMatrix_zp zp){
    ...
    for (t=0; t<zp.rows; t++){
        zc.data[t][0] = tConvert_pc(zp.data[t][0]);
    }
return zc;
}

tMatrix_zp tMatCon_cp(tMatrix_zc zc){
    int t;
    tMatrix_zp zp;
    ...
    for (t=0; t<zc.rows; t++){
        zp.data[t][0] = tConvert_cp(zc.data[t][0]);
    }
return zp;
}
